...
parser.add_argument('--name', default='name', help='Directory for load weight.')
...
if pth_data.type().find('FloatTensor')>0:
    width = 32
    print('RGB_image :', pth_data.shape)
    pth_data = pth_data.permute(0, 2, 3, 1)
    print('RGB_image Permuted :', pth_data.shape)
