...
def postprocess(det_output, w, h, batch_idx=0, interpolation_mode='bilinear',
    ...
    if cfg.mask_type == mask_type.lincomb and cfg.eval_mask_branch:
        ...
        # torch.save(masks.t(), os.path.join('./origin_data/pth/One_batch/0iter/POSTPROCESS/MASKS_T.pth'))
        # torch.save(proto_data, os.path.join('./origin_data/pth/One_batch/0iter/POSTPROCESS/PROTO_DATA.pth'))
